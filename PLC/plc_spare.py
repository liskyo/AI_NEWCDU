                ...
                try:
                    with ModbusTcpClient(host=modbus_host, port=modbus_port) as client:
                        ...
                        for i in range(ad_count, all_count, 2):
                            temp1 = [
                                all_sensors.registers[i],
                                all_sensors.registers[i + 1],
                            ]
                            decoder_big_endian = BinaryPayloadDecoder.fromRegisters(
                                temp1, byteorder=Endian.Big, wordorder=Endian.Little
                            )
                        ...
                        if not ver_switch["flow2_switch"]:
                            try:
                                ...
                                if not f2.isError():
                                    ...
                                    sensor_raw["Wtr_Flow"] = serial_sensor_value[
                                        "Wtr_Flow"
                                    ]
                    ...
                    with ModbusTcpClient(host=modbus_host, port=modbus_port) as client:
                        ...
                        if r.bits[0]:
                            ...
                            for key in key_list:
                                ...
                                if "Prsr" in key:
                                    all_sensors_dict[key] = (
                                        all_sensors_dict[key] * 0.145038
                                    )

                                if "Flow" in key:
                                    all_sensors_dict[key] = (
                                        all_sensors_dict[key] * 0.2642
                                    )
                except Exception as e:
                ...
                if mode == "manual":
                    ...
                    if (
                        ...
                        if (
                            ...
                            if (
                                word_regs["inv1_speed_set"]
                                == word_regs["inv2_speed_set"]
                            ):
                                pump_signial = "both"
                                if word_regs["inv1_speed_set"] > 0:
                                    open_ev1()
                    ...
                    if inspection_data["start_btn"] == 2:
                        ...
                        try:
                            if inspection_data["step"] == 1:
                                ...
                                inspection_data["prev"]["inv1"] = bit_output_regs[
                                    "inv1_en"
                                ]
                                inspection_data["prev"]["inv2"] = bit_output_regs[
                                    "inv2_en"
                                ]
                            ...
                            if inspection_data["step"] == 3:
                                ...
                                inspect_ev(
                                    "EV1_Open", "EV2_Open", "EV3_Close", "EV4_Close"
                                )
                            ...
                            if inspection_data["step"] == 6:
                                ...
                                journal_logger.info(
                                    f"6. 開 water：等 {water_open_time} 秒"
                                )
                            ...
                            if inspection_data["step"] == 7.5:
                                ...
                                journal_logger.info(
                                    f"7.5. 開 Pump2：等 {ev_open_time} 秒"
                                )
                            ...
                            if inspection_data["step"] == 8:
                                ...
                                inspect_ev(
                                    "EV1_Close", "EV2_Close", "EV3_Open", "EV4_Open"
                                )
                                ...
                                if any(p2_error_box):
                                    ...
                                    try:
                                        ...
                                        if (
                                            ...
                                            inspection_data["result"]["f1"].append(
                                                False
                                            )
                            ...
                            if inspection_data["step"] == 9.5:
                                ...
                                k = 0
                                for level in level_sw:
                                    inspection_data["result"][level] = not level_sw[
                                        level
                                    ]
                    ...
                    if pump1_run_current_time - pump1_run_last_min >= 60:
                        ...
                        try:
                            with ModbusTcpClient(
                                ...
                                rt1_min = split_double(
                                    [dword_regs["pump1_run_time_min"]]
                                )
                    ...
                    if pump2_run_current_time - pump2_run_last_min >= 60:
                        ...
                        try:
                            with ModbusTcpClient(
                                ...
                                rt2_min = split_double(
                                    [dword_regs["pump2_run_time_min"]]
                                )
                        ...
                        for filter_name, (min_reg, hr_reg) in filter_runtime[
                            ...
                            try:
                                with ModbusTcpClient(
                                    ...
                                    if not r.isError():
                                        previous_min = read_split_register(
                                            r.registers, 0
                                        )
                                        previous_hr = read_split_register(
                                            r.registers, 2
                                        )

                                        filter_runtime["runtime"][filter_name][
                                            "min"
                                        ] = previous_min
                ...
                try:
                    ...
                    try:
                        ...
                        if response.isError():
                            ...
                            print(f"Ambient Temperature: {t3}")
                    ...
                    try:
                        ...
                        if response.isError():
                            ...
                            print(f"Dew Point Temperature: {dewPt}")
                    ...
                    if ver_switch["flow_switch"]:
                        try:
                            ...
                            print(f"Coolant Flow Rate error: {e}")
                    ...
                    if ver_switch["flow2_switch"]:
                        try:
                            ...
                            if response.isError():
                                ...
                                print(f"Facility Water Flow Rate: {f2}")
                                raw_485_data["facility_water_flow_rate"] = f2
                                raw_485_communication["facility_water_flow_rate"] = (
                                    False
                                )

                        except Exception as e:
                            raw_485_communication["facility_water_flow_rate"] = True
                            print(f"Facility Water Flow Rate error: {e}")
                    ...
                    if not ver_switch["function_switch"]:
                        try:
                            ...
                            if response.isError():
                                ...
                                pw = abs(pw)
                                print(f"Instant Power Consumption: {pw}")
                                raw_485_data["instant_power_consumption"] = pw
                                raw_485_communication["instant_power_consumption"] = (
                                    False
                                )
                    ...
                    try:
                        ...
                        if response.isError():
                            ...
                            print(f"Inv1 Result: {inv1_result}")
                            if inv1_result > 0:
                    ...
                    try:
                        ...
                        if response.isError():
                            ...
                            print(f"Inv1 Result: {inv2_result}")
                            if inv2_result > 0:
                    ...
                    if not ver_switch["function_switch"]:
                        try:
                            ...
                            if not ats_read.isError():
                                ...
                                # journal_logger.info(f"Error response: {ats_read}")
                        except Exception as e:
                            raw_485_communication["ATS1"] = True
                            print(f"ATS error: {e}")
                            # journal_logger.info(f"ATS error: {e}")
                            print("failed address:10")
